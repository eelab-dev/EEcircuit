...
> = (set, get) => {
  ...
  generateDisplayNetlist: async () => {
    ...
    if (pdkResolution.geometryErrors.length > 0) notifySimulationErrors(pdkResolution.geometryErrors);
    ...
    const includeFiles = modelCardsFor(processId, gf180Corner, requiredModels);
